...
variable "name_prefix" {
  description = "Organization unique prefix to use for resource names. Designed to be generated by terraform-external-context module."
  type        = string
...
variable "tags" {
  description = "Tags/labels to apply to all resources (usually generated by terraform-external-context)."
  type        = map(string)
  default     = {}
}

variable "data_tags" {
  description = "Additional tags to apply specifically to data storage resources beyond the common tags (usually generated by terraform-external-context)."
  type        = map(string)
  default     = {}
}
